...
-device virtio-blk-pci,drive=format_node1,id=data1,bus=pcie.0-root-port-6 \
\
...
-device virtio-blk-pci,drive=format_node2,id=data2,bus=pcie.0-root-port-7 \
\
...
-device scsi-hd,drive=format_node3,id=data3 \
\
...
-device scsi-hd,drive=format_node4,id=data4 \
\
-drive file=/home/images/data4-1.raw,if=none,id=drive-scsi0-0-1-0,format=raw,cache=none \
-device scsi-hd,drive=drive-scsi0-0-1-0,id=data5 \
-drive file=/home/images/data4-2.raw,if=none,id=drive-scsi0-0-1-1,format=raw,cache=none 
