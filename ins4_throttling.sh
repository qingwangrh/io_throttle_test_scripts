/usr/libexec/qemu-kvm   \
 ...
 \
-object throttle-group,id=foo,x-bps-total=40960000,x-iops-total=400 \
...
-drive file=/home/images/data4.raw,if=none,id=drive-scsi0-0-1-0,format=raw,cache=none,bps=40960000,iops=400,throttling.group=scsi \
