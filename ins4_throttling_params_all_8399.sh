/usr/libexec/qemu-kvm   \
 ...
 \
-object throttle-group,id=foo,x-iops-read=100,x-iops-read-max=400,x-iops-write=100,x-iops-write-max=400,x-iops-write-max-length=5,x-bps-read=512000,x-bps-read-max=5120000,x-bps-read-max-length=5,x-bps-write=1024000,x-bps-write-max=10240000,x-bps-write-max-length=5 \
