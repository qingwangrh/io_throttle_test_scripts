...
-device virtio-blk-pci,drive=drive_stg1,id=data,bus=pcie.0-root-port-6,addr=0x0 \
 \
-device virtio-scsi-pci,id=scsi0 \
-drive file=/home/images/data4.raw,if=none,id=drive-scsi0-0-1-0,format=raw,cache=none \
